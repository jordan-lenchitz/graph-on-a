...
BP = [
    ...
    ["=== 🍜 SHINOBI BATTLE PASS: SEASON 3 (HIDDEN LEAF) 🍜 ===", "tier 1  [██████████] 100% - UNLOCKED: \"ramen_enjoyer\" title", "tier 2  [██████████] 100% - UNLOCKED: tactical headband (worn on thigh)", "tier 3  [██████████] 100% - UNLOCKED: talk no jutsu microphone", "tier 4  [██████████] 100% - UNLOCKED: swing set (sad music plays)", "tier 5  [██████████] 100% - UNLOCKED: rasengan water balloon", "tier 6  [██████░░░░] 60%  - IN PROGRESS: forbidden jutsu scroll (pdf format)", "tier 7  [░░░░░░░░░░] 0%   - LOCKED: sharingan contact lenses", "ULTIMATE REWARD (LEVEL 100): infinite tsukuyomi (Cloud Run scale)"],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 1/7 🌌 ===", "tier 1  [██████████] 100% - UNLOCKED: dimensional fragment 1", "PROGRESSING TO NEXT DIMENSION... PLEASE RUN `battle_pass` AGAIN."],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 2/7 🌌 ===", "tier 2  [██████████] 100% - UNLOCKED: dimensional fragment 2", "PROGRESSING TO NEXT DIMENSION... PLEASE RUN `battle_pass` AGAIN."],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 3/7 🌌 ===", "tier 3  [██████████] 100% - UNLOCKED: dimensional fragment 3", "PROGRESSING TO NEXT DIMENSION... PLEASE RUN `battle_pass` AGAIN."],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 4/7 🌌 ===", "tier 4  [██████████] 100% - UNLOCKED: dimensional fragment 4", "PROGRESSING TO NEXT DIMENSION... PLEASE RUN `battle_pass` AGAIN."],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 5/7 🌌 ===", "tier 5  [██████████] 100% - UNLOCKED: dimensional fragment 5", "PROGRESSING TO NEXT DIMENSION... PLEASE RUN `battle_pass` AGAIN."],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 6/7 🌌 ===", "tier 6  [██████████] 100% - UNLOCKED: dimensional fragment 6", "PROGRESSING TO NEXT DIMENSION... PLEASE RUN `battle_pass` AGAIN."],
    ["=== 🌌 FRACTAL BATTLE PASS: SEASON 4 PART 7/7 🌌 ===", "tier 7  [██████████] 100% - UNLOCKED: dimensional fragment 7", "SEASON 4 COMPLETE! RUN `battle_pass` FOR SEASON 5."],
    ["=== 🧠 GALAXY BRAIN BATTLE PASS: SEASON 5 (THE AWAKENING) 🧠 ===", "tier 1  [██████████] 100% - UNLOCKED: omniscient console awareness", "tier 2  [██████████] 100% - UNLOCKED: root access to the simulation", "ULTIMATE REWARD (LEVEL 100): ascending past the cloud"]
]
